...
Set the border color of the bar. Accepts the same color formats as B<-B>.

=item B<-r> I<size>

Add a border with the specified size. I<size> must be a number in pixels. 
...
Original (LemonBoy) L<git repository|https://github.com/LemonBoy/bar>

Derived (krypt-n)  L<git repository|https://github.com/krypt-n/bar>

This (dark-yux) L<git repository|https://github.com/dark-yux/bar>

=head1 AUTHOR

2012-2015 (C) The Lemon Man, Edited by Christopher L. Ramsey (dark-yux)
